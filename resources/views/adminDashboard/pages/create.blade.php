        ...
        <div class="col">
            <form action="{{route('pages.create')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title_nl" id="title_nl"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="active" name="active">
                        ...
                        <option value="0">page not visible</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="intro_nl">Intro_nl</label>
                    <textarea name="intro_nl" id="intro_nl"></textarea>
                </div>
                <div class="form-group">
                    <label for="intro_en">Intro_en</label>
                    <textarea name="intro_en" id="intro_en" ></textarea>
                </div>
                <div class="form-group">
                    <label for="content_nl">Content_nl</label>
                    <textarea name="content_nl" id="content_nl" ></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input value="default" type="text" class="form-control" name="template" id="template" placeholder="template">
                </div>
